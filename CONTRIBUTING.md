...
1. Check existing [Issues](https://github.com/akamura/net-commander/issues) to see if it’s already been reported.  
...
- [`good first issue`](https://github.com/akamura/net-commander/labels/good%20first%20issue)
- [`help wanted`](https://github.com/akamura/net-commander/labels/help%20wanted)
